...
export async function generateMetadata({ params }) {
  ...
  if (CATEGORIES.includes(slug)) {
    ...
    return {
      title: `CineVora - ${title} Movies`,
      description: `Explore the ${title} movies collection on CineVora.`,
    };
  }
  ...
  if (genreMatch) {
    ...
    return {
      title: `CineVora - ${genreName} Movies`,
      description: `Discover ${genreName} movies on CineVora.`,
    };
  }
