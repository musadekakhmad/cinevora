...
export async function generateMetadata({ params }) {
  ...
  const pageUrl = `https://cinevora.pages.dev/tv-show/genre/${genreName}`;
  const imageUrl = 'https://live.staticflickr.com/65535/55296812359_eee20011a7_b.jpg';

  return {
    title: `CineVora - ${title} TV Series`,
    description: `Find and watch the best ${title} TV series for free on CineVora.`,
    openGraph: {
      title: `CineVora - ${title} TV Series`,
      description: `Find and watch the best ${title} TV series for free on CineVora.`,
      url: pageUrl,
